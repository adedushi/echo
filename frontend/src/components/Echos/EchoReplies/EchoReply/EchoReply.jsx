    ...
    if (!isComment) {
        ...
        return (
            ...
            <div className="reply-comment-box" >
                <div className="reply-content" >
                        {!showFollow && profileImageUrl && <img className="reply-profile-image" src={profileImageUrl} alt="profile" onMouseEnter={() => { if (currentUserId !== authorId) setShowFollow(true) }} />}
                        {showFollow && 
                        <div className='reply-follow-modal-comments' onClick={handleFollow} onMouseLeave={() => setShowFollow(false)}>
                            {isFollowing ? 'Unfollow' : 'Follow'}
                        </div>
                        }
